...
public class SpamPlus extends Module {
    ...
    public SpamPlus() {
        super(BidoofMeteor.CATEGORY, "spam-plus", "Better than spam.");
    }
    ...
    private static final List<String> BEE_MOVIE = Lists.newArrayList(
        ...
        "- What does that do? - Catches that little strand of honey",
        ...
        "Ken, could you close the window please?",
        "Check out my new resume. I made it into a fold-out brochure.",
        "You see? Folds out.",
        ...
        "It's bread and cinnamon and frosting. They heat it up... really hot! - Listen to me!",
        "Sit down!",
        ...
        "They are pinheads!",
        "Pinhead.",
        "- Check out the new smoker. - Oh, sweet. That's the one you want.",
        "The Thomas 3000!",
        "Smoker?",
        ...
        "Superior Court of New York, Barry Bee Benson v. the Honey Industry",
        "is now in session.",
        ...
        "And we will no longer tolerate bee-negative nicknames... unnecessary inclusion of honey in bogus health products",
        ...
        "Tournament of Roses, Pasadena, Californa.",
        ...
        "Barry Benson, fresh from his legal victory... is attempting to land a plane, loaded with people, flowers.",
        "That's Barry!",
